        ...
        <div>
            <div className="container lg:px-5 lg:py-10 mx-auto">
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="flex flex-col items-center bg-white rounded-lg p-6 shadow-md lg:w-2/3 w-full  ">
                    ...
                    <div className="lg:flex lg:gap-8 ">
                            ...
                            <div className="lg:flex lg:flex-col lg:items-center lg:bg-white lg:rounded-lg lg:p-6 lg:shadow-md flex flex-col items-center bg-white rounded-lg p-6 shadow-md w-full mt-6">
