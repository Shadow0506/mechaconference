export function AboutUs_home() {
  return (
    <div>
     <div className="container px-5 py-5 mt-10 mx-auto flex flex-col">
          ...
          <div class="mx-auto">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400 mt-7">
                ...
                <div class="flex flex-col items-center text-center justify-center">
                  <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Punjab Engineering College</h2>
                  {/* <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">(Deemed To Be University)</h2> */}
                  <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Chandigarh</h2>
