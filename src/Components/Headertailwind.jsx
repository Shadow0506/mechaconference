...
export function Headertailwind() {
    ...
    return (
        <nav className="bg-gray-900 md:pb-5 pt-5">
            <div className="container ml-16 lg:mx-auto flex items-center justify-between py-4 lg:max-w-screen-xl lg:flex lg:items-center lg:justify-between ">
                <div className="flex items-center space-x-6 lg:flex lg:items-center lg:justify-center md:justify-between lg:space-x-8 lg:mx-auto">
                    <a href="/">
                        <img className="h-14  md:h-20 lg:h-36" src={pec_circle} alt="peclogo" />
                    </a>
                    <a href="/">
                        <img className="h-14  md:h-20 lg:h-36" src={logo_nobg} alt="peclogo" />
                    </a>
                    <a href="/">
                        <img className="h-14   md:h-20 lg:h-36" src="https://iitr.ac.in/Centres/International%20Centre%20of%20Excellence%20for%20Dams/assets/b62ae2df8a426804bc7c58955ceeb977e240a0727ae0018eb62a6c637ab5b135_SRIC.png" alt="iitrlogo" />
                    </a>
